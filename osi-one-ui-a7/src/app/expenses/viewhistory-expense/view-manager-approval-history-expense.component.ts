...
@Component({
  ...
  templateUrl: './view-manager-approval-history-expense.component.html',
  styleUrls: ['./view-manager-approval-history-expense.component.css']
})
export class ViewManagerApprovalHistoryExpenseComponent implements OnInit {
  ...
  cancel() {
    ...
     if (this.currentRepStatus  ==  'Approved'  ||  this.currentRepStatus  ==  'Rejected') {
      this.router.navigate(['../../review-manager-expense',  this.currentRepId,  this.currentRepStatus], {  relativeTo:  this.route  });
    } 

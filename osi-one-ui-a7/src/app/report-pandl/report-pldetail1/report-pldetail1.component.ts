...
// @Component({
//   selector: 'app-report-pldetail1',
//   templateUrl: './report-pldetail1.component.html',
//   styleUrls: ['./report-pldetail1.component.css']
// })
// export class ReportPldetail1Component implements OnInit {
...
export class ReportPldetail1Component implements OnInit {
  ...
  buttonClass: string = 'btn btn-custom-filter btn-custom-filter--floated pldetail_1';
  ...
  showfilters() {
    ...
    this.buttonClass = 'btn btn-custom-filter btn-custom-filter--floated pldetail_1 hidden';
  }

  closingFilters(event) {
    this.buttonClass = 'btn btn-custom-filter btn-custom-filter--floated pldetail_1';
